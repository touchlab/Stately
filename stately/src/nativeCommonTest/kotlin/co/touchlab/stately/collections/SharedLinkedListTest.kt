...
class LinkedListTest {
  ...
  private fun checkList(ll: FastNativeLinkedList<ListData>, vararg strings: String): Boolean {
  ...
  fun internalNodeAt() {
    ...
    val empty = FastNativeLinkedList<ListData>()
  ...
  fun mtNodeAdd() {
    val LOOPS = 1_000
    val DOOPS = 100
    val ll = FastNativeLinkedList<ListData>().freeze()
    val nodeList = mutableListOf<AbstractFastNativeLinkedList.Node<ListData>>()
