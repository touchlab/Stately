...
class FastNativeLinkedListTest : OrderedIterableTests<FastNativeLinkedList<String>>({
    nativeListOf(*it) as FastNativeLinkedList<String> },
    nativeListOf<String>() as FastNativeLinkedList<String>)
