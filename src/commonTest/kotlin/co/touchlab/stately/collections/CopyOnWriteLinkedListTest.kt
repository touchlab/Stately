...
class CopyOnWriteLinkedListTest2{
    
    fun <T> createLinkedCopyOnWriteList():MutableList<T>
    {
        return CopyOnWriteLinkedList<T>()
    }

    @Test
    fun testStableReads() {
        val list = createLinkedCopyOnWriteList<ListData>()
    ...
    @Test
    fun contains() {
        val list = createLinkedCopyOnWriteList<ListData>().mpfreeze()
